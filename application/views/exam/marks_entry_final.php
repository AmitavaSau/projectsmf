        ...
        <div class="col-lg-12 mb-4 mb-lg-0">
            <div class="card">
                <div class="card-header">
                    <h2 class="h6 text-uppercase mb-0">Marks Entry for Final</h2>
                </div>
                <div class="card-body">
                    <!-- search form-->
                    <form method="POST" action="<?php echo base_url('examMarks/marks_entry_final'); ?>"
                        id="marks_entry_final">
                        ...
                        <div class="row d-flex justify-content-end">
                            <div class="form-group col-md-2">
                                <button class="btn btn-dark marks_entry_search_final" type="button"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" data-markscount="<?php echo $n; ?>"
                                        class="btn btn-primary marks_entry_save_final">SAVE</button>
                                </td>
                            </tr>
                            <?php
                                    $n++;
                    ...
                    <div class="form-group mt-3">
                        <a class="btn btn-warning btn-sm download_report_final">DOWNLOAD</a>
                    </div>
