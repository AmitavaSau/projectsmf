      ...
      <div class="container">
        <div class="row align-items-center py-3">
          <div class="col-lg-12 mx-auto mb-5 mb-lg-0">
          	<h1 class="org-name text-primary"></h1>
          	<h3 class="appl-name">Counselling Management System</h3>
          </div>
       	</div>   
        <div class="row align-items-center py-2">
          <div class="col-5 col-lg-7 mx-auto mb-5 mb-lg-0">
            <div class="pr-lg-5"><img src="<?php echo $this->config->base_url();?>assets/img/illustration.svg" alt="" class="img-fluid"></div>
          </div>
          <div class="col-lg-5 px-lg-4">
            ...
            <?php
				...
				echo form_open('auth/authenticate', $form);
			?>
        ...
        <p class="mt-5 mb-0 text-gray-400 text-center">Design by <a href="#" class="external text-gray-400"></a></p>
      </div>
    </div>
    <!-- JavaScript files-->
