		...
		<div class="col-lg-12 mb-4 mb-lg-0">
			<div class="card">
				<div class="card-header">
					<h2 class="h6 text-uppercase mb-0">Search Course</h2>
				</div>
				<div class="card-body">            
				<!-- search form-->
					<?php
					...
					<div class="row mb-4">
						...
						<div class="form-group col-md-6">
							...
							<?php
								$extra_crs_name = array(
									'id'    => 	'course_name',
									'class' => 	'form-control course_name '
								);
								echo form_dropdown('course_name', $course_name_options, $crs_code, $extra_crs_name);
								?>
						</div>
...
<script>
    $(document).on('click','.btn-clg-seats-search',function(){
        ...
        if ((course_name != '')&&(category != ''))  {
            window.location.href = "search_course_seats?crs_code="+course_name+"&category="+category;
