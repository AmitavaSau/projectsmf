            ...
            <div class="row py-3 ">
                <div class="form-group col-md-12 text-center ">
                    ...
                    <a class="btn ml-2" style="background-color: #a84184fc;" href="
                                <?php echo $this->config->base_url(); ?>smfAdmin/data_viewing_dfharma"
                        class="link">Back</a>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-sm-12 col-xs-12">
                <div id="" class="m-t-30">
                    <?php
                        ...
                        echo form_open_multipart('admin/data_viewing_dfharma', $form);
                        ?>
                    <div class="highlight">
                        <div class="row ">
                            ...
                            <div class="form-group col-md-4">
                                <button type="button" class="btn btn-primary btn-dfharma-search">Search</button>
...
$('#Form').on('submit', function(e) {
    ...
    if (!error_remarks) {
        ...
        const url = '../save_remarks_dfharma';
